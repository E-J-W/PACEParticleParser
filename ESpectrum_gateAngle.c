...
int main(int argc, char *argv[])
{
  ...
  if(argc!=5)
    {
      printf("PACE_ESpectrum_gateAngle particles_file min max binning\n");
      printf("\nGenerates an energy spectrum (histogram) for particles in the input\n.particles file generated by PACE4.\n");
      printf("Particles are gated by the angle of the projectile (in deg) of the\ncompound nucleus via the 'min' and 'max' parameters.\n");
